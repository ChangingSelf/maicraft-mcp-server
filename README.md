...
- 🖼️ **截图功能**：生成第一人称视角游戏截图
- 🔥 **熔炉操作**：完整的熔炉交互（放入/取出物品，查看状态）
- 🎯 **基础控制**：移动、跳跃、潜行、视角调整、物品丢弃、睡觉等
- 🍎 **物品使用**：智能物品使用（食用、激活、对实体使用）
